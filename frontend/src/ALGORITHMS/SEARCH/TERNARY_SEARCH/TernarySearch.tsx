...
import TernarySearchKonva from "./TernarySearchKonva";
...
export default function TernarySearch() {
    ...
    const getTernarySearch = searchStore((state: any) => state.getTernarySearch);
    const TernarySearchInfo = searchStore((state: any) => state.TernarySearchInfo);
    ...
    const TernarySearchPayload: SortKit = {
        algoInfo: TernarySearchInfo.algoInfo,
        algoName: TernarySearchInfo.algoName,
        codes: TernarySearchInfo.codes,
        editAlgoInfo: editSortCode
    };



    const TernaryKonvaPayload: TernarySearchPayload = {
    ...
    return <main className="w-screen h-screen flex  gap-5 overflow-x-hidden p-2 bg-black ">
        ...
        <AlgoInfo algoInfo={TernarySearchPayload} />
