...
export default function Navbar({ onScrollNext }: NavbarProps) {
    ...
    return <nav className="lg:h-[65px] lg:w-full bg-black border-2  lg:flex p-3 lg:justify-center
    dark:border-black flex justify-center"
        style={{ scrollbarWidth: "none" }}>

        <div className=" dark:border-black lg:w-[15%] items-center justify-center hidden lg:flex">

            <h1 className={`lg:text-4xl text-2xl text-black LOGO  duration-100 cursor-pointer
        ...
        <div className="lg:w-1/2 flex gap-8  justify-center items-center">
            ...
            <a onClick={onScrollNext}>
                <h1 className={`${Admin ? "text-red-600" : "text-white"} lg:text-2xl cursor-pointer  duration-150 text-3xl
        ...
        <div className="lg:w-[15%] flex items-center justify-center ">
            <a>
                <h1 className={`lg:text-4xl text-white text-2xl hidden lg:block 
