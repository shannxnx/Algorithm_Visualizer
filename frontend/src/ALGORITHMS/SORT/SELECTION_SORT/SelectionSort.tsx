...
export default function SelectionSort() {
    ...
    const getSelectionSort = sortStore((state: any) => state.getSelectionSort);
    const selectionSortInfo = sortStore((state: any) => state.selectionSortInfo);
    ...
    const SelectionPayload: SortKit = {
        ...
        algoInfo: selectionSortInfo.algoInfo,
        codes: selectionSortInfo.codes,
        editAlgoInfo: editSortCode

    };


    const SelectionSortKonvaProps: SelectionPayload = {
    ...
    return <main className="w-screen h-screen flex gap-5 overflow-x-hidden p-2 bg-black">
        ...
        <AlgoInfo algoInfo={SelectionPayload} />
