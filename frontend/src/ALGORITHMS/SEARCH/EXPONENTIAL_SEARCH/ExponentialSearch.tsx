...
export default function ExponentialSearch() {
    ...
    const getExponentialSearch = searchStore((state: any) => state.getExponentialSearch);
    const ExponentialSearchInfo = searchStore((state: any) => state.ExponentialSearchInfo);
    ...
    const ExponentialSearchPayload: SortKit = {
        algoInfo: ExponentialSearchInfo.algoInfo,
        algoName: ExponentialSearchInfo.algoName,
        codes: ExponentialSearchInfo.codes,
        editAlgoInfo: editSortCode
    };



    const ExponentialKonvaPayload: ExponentialSearchPayload = {
    ...
    return <main className="w-screen h-screen flex  gap-5 overflow-x-hidden p-2 bg-black ">
        ...
        items-center" ref={ref}>
            ...
            <div className="w-[95%] h-[75%] border-1
             ...
             overflow-x-scroll border-black" style={{ scrollbarGutter: "stable" }}>
                ...
                {
                    rectsArray.length > 0 ? <ExponentialSearchKonva props={ExponentialKonvaPayload} />
                        : null
                }
            </div>
        ...
        <AlgoInfo algoInfo={ExponentialSearchPayload} />
