...
const LinearSearchKonva: React.FC<LinearSearchProps> = ({ props }) => {
    ...
    useEffect(() => {
        ...
        if (props.isAnimating === "animating") {
            ...
            (async () => {
                await LinearSearchAnimation(props.boxesInfo, props.searchValue!, props.setBoxesInfo);
            })()
...
export default LinearSearchKonva;
