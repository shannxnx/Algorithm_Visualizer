...
export default function Layout() {
    ...
    return <main className="w-screen h-screen flex gap-5 overflow-x-hidden p-2 bg-black">
        ...
        items-center">
            ...
            <div className="w-[95%] h-[120px] flex border-1 items-center justify-end mb-3">

                <div className="w-[440px] h-[120px]  
        ...
        <div className="w-[40%] h-full border-1 rounded flex-col flex  items-center bg-white">
            <h1 className="text-3xl mt-4">ALGO NAME</h1>


            <div className="mt-4 border-1 w-[90%] h-[65%] overflow-scroll p-2">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem vel maxime ducimus veniam omnis sequi repellat?
                Quasi, minus vitae! Magni necessitatibus ex id neque maxime minus. Sint nihil hic aperiam.
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate facere, iusto dolor, tenetur
                voluptates dolore cum iure voluptas molestiae, necessitatibus eius! Maxime excepturi quam inventore
                sapiente labore voluptate nemo nobis.
                Cum, ducimus reprehenderit modi necessitatibus perspiciatis facilis laboriosam labore neque quas
                molestiae officia dicta et quibusdam soluta voluptatum nostrum accusantium. Corporis perspiciatis
                maxime quas harum illo, assumenda pariatur aspernatur quibusdam!
                Eligendi magni placeat doloremque officiis illo provident officia voluptas quidem maiores veniam
                accusamus repellat id, perferendis eum laboriosam tempore assumenda. Nihil voluptatum laudantium
                provident culpa tenetur voluptas ex quibusdam quidem!
                Beatae, exercitationem vitae? Eveniet voluptates blanditiis similique,
                a alias ipsam tenetur voluptatibus deleniti quae, consequuntur necessitatibus in neque
                animi sunt fugit voluptas voluptate laborum ducimus eligendi. Totam ab odio doloribus!
            </div>


            <div className="w-[90%] h-[15%] mt-8 border-1 flex items-center p-2 justify-around">

                <button className="w-[23%]  border-1 cursor-pointer text-2xl rounded
                hover:scale-105 duration-100 disabled:opacity-50 "
                    onClick={handleAdd}
                    disabled={isAnimating}
                >
                ...
                <button className={`w-[23%]  border-1 cursor-pointer text-2xl p-1 rounded
                bg-green-400 hover:scale-105 duration-100
                transition-colors disabled:opacity-50 disabled:cursor-not-allowed 
                ${isAnimating ? 'bg-red-500 border-red-400' : 'bg-green-200 border-green-400'}`}
